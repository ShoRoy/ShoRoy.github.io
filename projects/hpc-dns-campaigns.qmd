...
::: {.wide-media}
```{=html}
<video autoplay loop muted playsinline style="max-width: 100%; max-height: 75vh; height: auto; display: block; margin: 0 auto;" aria-label="Time evolution of a production-scale SCIMITAR3D shock-to-detonation simulation: the shock wave propagates through a multi-crystal HMX-binder microstructure with reacted regions emerging at hotspots and growing as the burn-front advances.">
  <source src="../assets/DNS_PBX.mp4" type="video/mp4">
</video>
<div class="caption">Time evolution of a production-scale SCIMITAR3D shock-to-detonation simulation on a multi-crystal HMX-Estane microstructure (20 &micro;m scale bar). The flyer-driven shock enters from the top; reacted regions (red) emerge at hotspots and grow as the burn front propagates downward through the heterogeneous domain.</div>
```
:::

**Role:** Sole simulation lead (PhD and postdoc); validation in partnership with UIUC (Dlott group) and Los Alamos National Laboratory.
...
- **Roy**, Johnson, Zhou, Nguyen, Dlott, Udaykumar &mdash; *Hot Spot Ignition and Growth from Tandem Micro-Scale Simulations and Experiments on Plastic-Bonded Explosives*, **Journal of Applied Physics** 131(20), 2022. [doi:10.1063/5.0085356](https://doi.org/10.1063/5.0085356)
- *Code & data: SCIMITAR3D solver is group-internal (Udaykumar lab, UIowa); DNS datasets are reused as ground-truth benchmarks for downstream physics-aware ML.*